...
namespace Ttn {
  ...
  namespace pipelines {
    ...
    class Ttn_Graphic_Pipeline {
      ...
      public:
        Ttn_Graphic_Pipeline(VkDevice, Ttn::Logger&, Ttn::swapchain::Ttn_SwapChain&, Ttn::pipelines::Ttn_Renderpass&, Ttn::vertex::Ttn_Vertex_Buffer&, VkImageView, VkSampler, size_t, Ttn::vertex::TtnVertex&, VkSampleCountFlagBits);
